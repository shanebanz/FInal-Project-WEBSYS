...
<div class="card">
    <div class="card-body">
        <form action="<?= base_url('equipment/edit/' . $equipment['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?= isset($validation) && $validation->hasError('equipment_id') ? 'is-invalid' : '' ?>" 
                               id="equipment_id" name="equipment_id" value="<?= old('equipment_id', $equipment['equipment_id']) ?>" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control <?= isset($validation) && $validation->hasError('total_quantity') ? 'is-invalid' : '' ?>" 
                               id="total_quantity" name="total_quantity" value="<?= old('total_quantity', $equipment['total_quantity']) ?>" min="0" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <?php if ($equipment['image']): ?>
                            <div class="mb-2">
                                <img src="<?= base_url('uploads/equipment/' . $equipment['image']) ?>" alt="Current Image" style="max-width: 200px;">
                            </div>
                        <?php endif; ?>
